                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">
                                        {{ trans('main_translation.ShowOffer') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title mb-2">{{ trans('main_translation.ShowOffer') }}</div>
                                </div>
                                <div class="card-body">
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img id="image" src="{{ asset('storage/' . $offer->image) }}"
                                                        alt="" height="100" width="150">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="font-weight-bold">{{ trans('main_translation.OfferTitle') }}
                                                </td>
                                                <td>{{ $offer->title }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $offer->created_at?->translatedFormat('l , j F Y , H:i:s') ?? 'N/A' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="font-weight-bold">{{ trans('main_translation.UpdatedAt') }}</td>
                                                <td>
                                                    {{ $offer->updated_at?->translatedFormat('l , j F Y , H:i:s') ?? 'N/A' }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
